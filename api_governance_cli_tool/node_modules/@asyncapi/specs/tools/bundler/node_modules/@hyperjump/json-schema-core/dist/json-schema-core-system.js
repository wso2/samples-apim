  ...
  return {
    execute: (function () {
      ...
      */
      ...
      var lib = exports('default', { Core: core, Schema: schema, Instance: instance, Reference: reference, Keywords: keywords, InvalidSchemaError: invalidSchemaError });
      var lib_1 = exports('Core', lib.Core);
      var lib_2 = exports('Schema', lib.Schema);
      var lib_3 = exports('Instance', lib.Instance);
      var lib_4 = exports('Reference', lib.Reference);
      var lib_5 = exports('Keywords', lib.Keywords);
      var lib_6 = exports('InvalidSchemaError', lib.InvalidSchemaError);

    })
  };
}));
//# sourceMappingURL=json-schema-core-system.js.map
