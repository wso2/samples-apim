...
${KUBECTL} create -f  HelloKubernetes/kubernetes/helloKubernetesService/helloKubernetesService_svc.yaml -n wso2
#update <PATH_FOR_THE_SERICE_DEPLOYMENT_YML_FILE> with your backend service deployment yml file
${KUBECTL} create -f HelloKubernetes/kubernetes/helloKubernetesService/helloKubernetesService_deployment.yaml -n wso2
sleep 10s
echoBold 'Finished'
