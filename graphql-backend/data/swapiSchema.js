...
const humans = [
  {
    id: '1000',
    name: 'Luke Skywalker',
    friends: [ '1002', '1003', '1006', '1007', '2000', '2001' ],
  ...
  },
  {
    ...
    name: 'Darth Vader',
    friends: [ '1004', '1005' ],
    appearsIn: [ 'NEWHOPE', 'EMPIRE', 'JEDI', 'SITH' ],
    homePlanet: 'Tatooine',
    height: 2.02,
    mass: 136,
    starships: [ '3002' ],
  ...
  },
  {
    id: '1003',
    name: 'Leia Organa',
    friends: [ '1000', '1002', '1007', '2000', '2001' ],
    appearsIn: [ 'NEWHOPE', 'EMPIRE', 'JEDI' ],
    homePlanet: 'Alderaan',
    height: 1.5,
    mass: 49,
...
const characterList = humans.concat(droids);
...
const resolvers = {
  Query: {
    ...
    allHumans: (root, { first }) => {
      first = first || humans.length;
      return humans.slice(0, first);
    },
    allDroids: (root, { first }) => {
      first = first || droids.length;
      return droids.slice(0, first);
    },
    allCharacters: (root, { first }) => {
      first = first || characterList.length;
      return characterList.slice(0, first);
    },
  },
  Mutation: {
